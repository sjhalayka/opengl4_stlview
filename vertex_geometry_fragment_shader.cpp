...
bool vertex_geometry_fragment_shader::init(const char *vertex_shader_filename, const char* geometry_shader_filename, const char *fragment_shader_filename)
{
...
void vertex_geometry_fragment_shader::use_program(void)
{
